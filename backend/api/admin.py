...
class ServiceInline(admin.TabularInline):  # или admin.StackedInline
    model = Service
    extra = 0
...
class PartnerInline(admin.TabularInline):  # или admin.StackedInline
    model = Partner
    extra = 0
...
class PartnerAdmin(admin.ModelAdmin):
    ...
    def get_logo(self, obj):
        """Возвращает лого."""
        return mark_safe(f"<img src={obj.logo} width='80' height='60'>")
